function tof = tripquad_v3(N, x, forcemono, zstrat)
%TRIPQUAD_V3 Piecewise-quadratic density profile.
%    TRIPQUAD_V3(N, x) returns an N-point TOFPlanet object with normalized rhoi
...
%    z=1/N.
%    
%    TRIPQUAD_V3(...,forcemono) where forcemono==true forces the resulting density
%    profile to be monotonically nonincreasing. Default forcemono is false.

if nargin == 0 && nargout == 0
    help('tofmodels.tripquad_v3')
    return
end
narginchk(2,4)
